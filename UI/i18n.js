...
(function (global) {
    ...
    const STR = {
        zh: {
            ...
            // --- IC-LoRA ---
            icLoraTitle: 'IC-LoRA 视频条件控制',
            icLoraDesc: '提取视频的边缘(Canny)或深度(Depth)信息，用于生成风格一致的新视频',
            icLoraSourceVideo: '源视频 (Source)',
            icLoraUploadVideo: '拖入或点击上传视频',
            icLoraConditioningType: '条件类型',
            icLoraCanny: 'Canny 边缘检测',
            icLoraDepth: 'Depth 深度图',
            icLoraFrameTime: '提取帧时间 (秒)',
            icLoraExtractBtn: '提取条件图像',
            icLoraPreview: '条件预览',
            icLoraStrength: '条件强度',
            icLoraSteps: '推理步数',
            icLoraRender: '开始 IC-LoRA 生成',
            icLoraNoVideo: '请先上传视频',
            icLoraNoConditioning: '请先提取条件图像',
            icLoraVideoUploaded: '视频已上传',
            icLoraVideoUploadFailed: '视频上传失败',
            icLoraExtracting: '正在提取...',
            icLoraExtracted: '条件提取成功',
            icLoraExtractFailed: '条件提取失败',
            // --- Retake ---
            retakeTitle: '视频片段重绘 / Retake',
            retakeDesc: '选择已有视频，替换指定时间范围的片段内容',
            retakeSelectVideo: '选择视频',
            retakeSelectPlaceholder: '-- 从历史记录选择视频 --',
            retakeDuration: '视频时长',
            retakeUnknownDuration: '未知',
            retakeStartTime: '起始时间 (秒)',
            retakeTimeError: '起始时间 + 持续时间不能超过视频总长',
            retakeMode: '替换模式',
            retakeReplaceVideo: '仅替换画面',
            retakeReplaceAudio: '仅替换音频',
            retakeReplaceBoth: '替换画面+音频',
            retakePrompt: '重绘提示词 (可选)',
            retakePromptPh: '输入用于替换片段的画面描述词，留空则使用原视频语义',
            retakeRender: '开始片段重绘',
            retakeNoVideo: '请选择要重绘的视频',
        },
        en: {
            tabVideo: 'Video',
            ...
            // --- IC-LoRA ---
            icLoraTitle: 'IC-LoRA Video Conditioning',
            icLoraDesc: 'Extract Canny or Depth information from video to generate stylistically consistent new videos',
            icLoraSourceVideo: 'Source Video',
            icLoraUploadVideo: 'Drop or click to upload video',
            icLoraConditioningType: 'Conditioning Type',
            icLoraCanny: 'Canny Edge Detection',
            icLoraDepth: 'Depth Map',
            icLoraFrameTime: 'Frame Time (seconds)',
            icLoraExtractBtn: 'Extract Conditioning',
            icLoraPreview: 'Conditioning Preview',
            icLoraStrength: 'Conditioning Strength',
            icLoraSteps: 'Inference Steps',
            icLoraRender: 'Start IC-LoRA Generation',
            icLoraNoVideo: 'Please upload a video first',
            icLoraNoConditioning: 'Please extract conditioning first',
            icLoraVideoUploaded: 'Video uploaded',
            icLoraVideoUploadFailed: 'Video upload failed',
            icLoraExtracting: 'Extracting...',
            icLoraExtracted: 'Conditioning extracted successfully',
            icLoraExtractFailed: 'Failed to extract conditioning',
            // --- Retake ---
            retakeTitle: 'Video Retake / Segment Replace',
            retakeDesc: 'Select an existing video and replace content within a specific time range',
            retakeSelectVideo: 'Select Video',
            retakeSelectPlaceholder: '-- Select from history --',
            retakeDuration: 'Duration',
            retakeUnknownDuration: 'Unknown',
            retakeStartTime: 'Start Time (seconds)',
            retakeTimeError: 'Start time + duration cannot exceed video length',
            retakeMode: 'Replacement Mode',
            retakeReplaceVideo: 'Replace video only',
            retakeReplaceAudio: 'Replace audio only',
            retakeReplaceBoth: 'Replace both video and audio',
            retakePrompt: 'Retake Prompt (optional)',
            retakePromptPh: 'Enter prompt for replacement segment, leave empty to use original video semantics',
            retakeRender: 'Start Retake',
            retakeNoVideo: 'Please select a video for retake',
        },
    };
